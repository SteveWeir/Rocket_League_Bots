...
# this function renders a line on the field that displays the car's target direction and action taken
def draw_debug(renderer, car, target, action_display, corner_debug=None):
    renderer.begin_rendering()
    # draw a line from the car to the target (boost)
...
def get_nearest_boost(info, packet, car_location):
    ...
    # This is nearly duplicate code, since we are looping over boost list twice
